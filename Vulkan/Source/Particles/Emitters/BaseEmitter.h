...
class CBaseEmitter //#EMITTERS przerobic to na baseEmitter, tamten usunac i zrobiæ dot ego IEmitter z prawdziego szdarzenie tzn interfejs
{
public:
    CBaseEmitter(const uint32_t& tech_id, const uint32_t& buffer_size);
